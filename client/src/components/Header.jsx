...
const onClickHandler = ()=>{
  ...
  return (
    ...
    viewport={{once: true}}>
        ...
        mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full hover:scale-105 transition-all duration-300 cursor-pointer'
        whileHover={{scale: 1.05}}
        whileTap={{scale: 0.95}}
        initial={{opacity:0 }}
        animate={{opacity:1}}
        transition={{default: {duration: 0}, opacity: {delay: 0.8, duration: 1.5 }}}
